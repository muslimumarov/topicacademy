...
function TopicAcademy() {
    ...
    const topics = [{id: 1, title: t("title1"), description: t("description1"), img: Box1}, {
        id: 2, title: t("title2"), description: t("description2"), answer: t("answer1"), img: Box2
    }, {id: 3, title: t("title3"), description: t("description3"), answer: t("answer2"), img: Box3}, {
        id: 4, title: t("title4"), description: t("description4"), answer: t("answer3"), img: Box4
    }, {id: 5, title: t("title5"), description: t("description5"), answer: t("answer4"), img: Box5}, {
        id: 6, title: t("title6"), description: t("description6"), answer: t("answer5"), img: Box6
    },];

    return (
        <>
            <h2 className="foryou-title">{t("topic-title")}</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 mb-20 lg:grid-cols-3 gap-14 p-4">
